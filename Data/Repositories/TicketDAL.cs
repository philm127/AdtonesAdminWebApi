...
namespace Data.Repositories
{
    public class TicketDAL : BaseDAL, ITicketDAL
    {
        ...
        public async Task<IEnumerable<TicketListModel>> GetOperatorTicketList(PagingSearchClass param)
        {
            ...
            builder.AddParameters(new { opadrev = (int)Domain.Enums.QuestionSubjectStatus.OperatorAdreview });
            builder.AddParameters(new { cred = (int)Domain.Enums.QuestionSubjectStatus.OperatorCreditRequest });
            builder.AddParameters(new { aderr = (int)Domain.Enums.QuestionSubjectStatus.AdvertError });
            builder.AddParameters(new { adreview = (int)Domain.Enums.QuestionSubjectStatus.Adreview });
