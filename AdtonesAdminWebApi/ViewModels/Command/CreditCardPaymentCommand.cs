...
{
    public class UserPaymentCommand
    {
        ...
        public int SubmittedCurrencyId { get; set; }
        public string SubmittedCurrencyCode { get; set; }
    ...
    public class CreditCardPaymentCommand : UserPaymentCommand
    {
